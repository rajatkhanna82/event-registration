...
@Component({
  selector: 'app-valuables-print',
  templateUrl: './valuables-print.component.html',
  styleUrls: ['./valuables-print.component.css']
})
export class ValuablesPrintComponent implements OnInit, AfterViewInit {
  sub: Subscription;
  category: string;
  day: string;
  participants: any[];
